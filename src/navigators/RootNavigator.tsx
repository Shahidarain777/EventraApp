...
const RootNavigator = () => {
  ...
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }} initialRouteName={token ? "Main" : "Auth"}>
      ...
      <Stack.Screen name="EarningsScreen" component={require('../screens/EarningsScreen').default} />
      ...
      <Stack.Screen name="ForgotPasswordScreen" component={require('../screens/ForgotPasswordScreen').default} />
    </Stack.Navigator>
  );
};
